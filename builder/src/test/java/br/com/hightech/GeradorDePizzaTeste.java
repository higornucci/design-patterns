...
public class GeradorDePizzaTeste {
	...
	public void deve_construir_uma_pizza_de_calabresa_com_azeitona() throws Exception {
		...
		Pizza pizzaDeCalabresaCriada = new PizzaCustomizadaBuilder().chamada("Calabresa").comTipoDeMolho(TipoDeMolho.VERMELHO).semBorda().comAdicionalDe(azeitonasPretas).criar();
	...
	public void deve_construir_uma_pizza_simples() throws Exception {
		Pizza pizzaSimples = new PizzaSimplesBuilder().chamada("Calabresa Simples").comTipoDeMolho(TipoDeMolho.VERMELHO).recheadaCom("Calabresa e Mussarela").criar();
